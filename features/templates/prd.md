...
| Frontend + Backend Deploy | Render.com | Tek platform — Flask hem API'yi hem arayüzü sunar |
...
| Deploy sürecinde teknik sorun | Düşük | Yüksek | Render tek platform — sorun olursa yeni servis açılır |
